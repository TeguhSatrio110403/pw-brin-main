...
const DashboardAdmin = () => {
    ...
    const menuItems = [
        ...
        // Tidak ada menu users/Manajemen User
    ];
                ...
                return (
                    <div style={{ padding: '0px 0px 24px 0px' }}>
                        ...
                        {anomaliLoading ? (
                            ...
                            <Row gutter={[16, 16]}>
                                {filteredAndKategoriAnomali.map((item, idx) => (
                ...
                <>
                    ...
                    >
                        ...
                        >
                            ...
                            {!editingId && (
                              <div style={{ marginBottom: 16 }}>
                                <label style={{ fontWeight: 'bold', marginBottom: 8, display: 'block' }}>Pilih Titik Lokasi di Peta</label>
